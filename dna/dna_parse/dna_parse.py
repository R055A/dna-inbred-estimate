...
from dna.dna_enum import DnaKitFileUniqueIdentifier
...
def dna_f_parse(file_name: str) -> ParseFileDNA | None:
    ...
    if file_name.endswith(".csv"):
        ...
        elif not isinstance(dna_f_parse_obj, ParseFileAncestryTXT) and not isinstance(
            dna_f_parse_obj, ParseFile23AndMeTXT
        ):
